...
public class LMS {
    public static void main(String[] args) {
        ...
        // PersistanceHandler persistanceHandler = new FileSystem();
        Library Lib;
        Scanner input_var = new Scanner(System.in);

        int storage;   
        do {     
            System.out.println("Choose the type of Storage you want: ");
            System.out.println("Press 1 for File Based ");
            System.out.println("Press 2 for MYSQL Based ");
            System.out.println("Enter your choice: ");
            storage = input_var.nextInt();
            System.out.println("Enter your choice: "+ storage);
        } while (storage < 1 || storage > 2);
        if (storage == 1){
            System.out.println("Storage Method File Based");
            Lib = new Library(2, 0);
        }
        else {
            System.out.println("Storage Method MYSQL Based");
            Lib = new Library(2, 1);
        }

        // ADDING RANDOM DATA
        // ---------------------------------------------------------------------------------------------------------------
        int start_book_id = Lib.book_id_start();
        int start_user_id = Lib.user_id_start();
        ...
        Lib.Add_Book(book19);
        // try {
        //     persistanceHandler.saveBooks(Lib.Get_all_books());
        // } catch (IOException e) {
        //     e.printStackTrace();
        // }
        ...
        do {
            ...
            System.out.println("9. Extending Loan");
            System.out.println("10. View all Loaned Books");
            ...
            switch (choice) {
                case 1:
                    ...
                    // }
                    // try{
                    //     System.out.println(persistanceHandler.loadBooks());
                    // } catch(IOException e) {
                    //     e.printStackTrace();
                    // }
                    Lib.Display_Available_Books();
                ...
                case 5:
                    ...
                    if (Book_Type == 1) {
                        ...
                        New_Book = new ReferenceBook(Integer.toString(start_book_id++), Title, Author, ISBN, Year, Genre, Base_Fee);
                    }
                ...
                case 6:
                    System.out.print("Enter Book ID: ");
                    String book_Id_remove = input_var.nextLine().trim();
                    Lib.Remove_book(book_Id_remove);
                    break;
                case 7:
                ...
                case 8:
                    ...
                    System.out.println("1. Searching for a User by Name");
                    System.out.println("2. Searching for a User by ID");
                    System.out.println("3. Searching for a Book by Name");
                    System.out.println("4. Searching for a Book by ID");
                    System.out.println("5. Searching for a Author by Name");
        
                    System.out.print("Enter your choice: ");
                    choice2 = input_var.nextInt();
                    input_var.nextLine(); 
                    System.out.println("\n");
                    switch (choice2) {
                        case 1:
                            System.out.println("Enter User name: ");
                            String user_name = input_var.nextLine();
                            Lib.find_user_name(user_name);
                            break;

                        case 2:
                            System.out.println("Enter User ID: ");
                            String user_id = input_var.nextLine();
                            Lib.find_user_id(user_id);
                            break;

                        case 3:
                            System.out.println("Enter Book Name: ");
                            String book_name = input_var.nextLine();
                            Lib.find_book_name(book_name);
                            break;

                        case 4:
                            System.out.println("Enter Book ID: ");
                            String book_id = input_var.nextLine();
                            Lib.find_book_id(book_id);
                            break;
                        ...
                        default:
                            System.out.println("Incorrect choice taken");
                    }
                    break;
                case 9:
                    System.out.println("Enter User ID: ");
                    String user_id = input_var.nextLine().trim();
                    System.out.println("Enter Book ID: ");
                    String book_id = input_var.nextLine().trim();
                    System.out.println("Enter the number of days to extend the loan period:");
                    int days = input_var.nextInt();
                    Lib.LoanExtension(user_id, book_id, days);
                    break;

                case 10:
                    System.out.println("Enter User ID: ");
                    String user_id1 = input_var.nextLine().trim();
                    Lib.view_loaned_books(user_id1);
                    break;
